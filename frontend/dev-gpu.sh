#!/bin/bash
# GPU-accelerated development script for Convoic
...
echo -e "${BLUE}🚀 Convoic GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting Convoic in development mode...${NC}"
echo ""
