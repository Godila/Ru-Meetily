    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        ...
        <div className="text-sm text-yellow-800">
          <p className="font-medium">Бета-функции</p>
          <p className="mt-1">
            Эти функции пока тестируются. Возможны проблемы — будем благодарны за обратную связь.
          </p>
        </div>
      </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Примечание:</strong> При отключении бета-функции скрываются. Существующие встречи не затрагиваются.
        </p>
      </div>
    </div>
  );
