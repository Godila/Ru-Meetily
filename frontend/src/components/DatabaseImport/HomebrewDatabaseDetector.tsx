...
export function HomebrewDatabaseDetector({ onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  const handleYes = async () => {
    try {
      ...
      toast.success('База данных успешно импортирована! Перезагрузка...');
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Обнаружена предыдущая установка Meetily!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            Мы нашли существующую базу данных от вашей предыдущей установки Meetly (версия с Python-бэкендом).
          </p>
          ...
          <p className="text-sm text-blue-800 mb-3">
            Хотите импортировать предыдущие встречи, транскрипции и резюме?
          </p>
