                ...
                {isMeetingItem && (
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                    <button
                      ...
                      aria-label="Редактировать название встречи"
                    >
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <ConfirmationModal
        ...
        text="Вы уверены, что хотите удалить эту встречу? Действие нельзя отменить."
      ...
      <Dialog open={editModalState.isOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[425px]">
          <VisuallyHidden>
            <DialogTitle>Редактировать название встречи</DialogTitle>
          </VisuallyHidden>
          <div className="py-4">
            <h3 className="text-lg font-semibold mb-4">Редактировать название встречи</h3>
