  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-semibold text-gray-800 mb-2">Аналитика использования</h3>
          <p className="text-sm text-gray-600 mb-4">
            Аналитика использования выключена по умолчанию. Вы можете включить её, чтобы делиться анонимными данными о продукте и производительности; личные данные не собираются.
          </p>
        </div>
          ...
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="font-medium text-gray-800 mb-1">Ваш ID пользователя</div>
                <p className="text-xs text-gray-600 mb-2">
                  Сообщите этот ID при обращении в поддержку для анализа логов
                </p>
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 rounded border border-blue-200">
          ...
          <div className="text-xs text-blue-700">
            <p className="mb-1">
              Ваши встречи, транскрипции и записи остаются полностью приватными и локальными.
            </p>
            <button
