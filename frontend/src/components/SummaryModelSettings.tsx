        ...
        <div className="flex items-center justify-between">
          <div className="pr-4">
            ...
            <p className="text-sm text-gray-600">
              {hasGpu
                ? gpuName
                  ? `Включите, чтобы резюме генерировалось на видеокарте «${gpuName}» — в несколько раз быстрее. Выключите, если важна максимальная точность (на процессоре модель рассуждает аккуратнее, но медленнее).`
                  : 'Включите, чтобы резюме генерировалось на видеокарте — в несколько раз быстрее. Выключите, если важна максимальная точность (на процессоре модель рассуждает аккуратнее, но медленнее).'
