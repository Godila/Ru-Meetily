# GPU-accelerated development script for Convoic (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Convoic" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Convoic in development mode..." -ForegroundColor Blue
Write-Host ""
