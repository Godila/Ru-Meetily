@echo off
REM Convoic Build Script for Windows
...
echo 🚀 Building Convoic application...
...
echo.
echo ========================================
echo    Convoic Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the Convoic Tauri application for Windows.
