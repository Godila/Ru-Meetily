...
/// Default GigaAM model for Russian transcription when the `gigaam` provider
/// is selected without a specific model. E2E RNN-T variant with punctuation,
/// int8 quantized.
pub const DEFAULT_GIGAAM_MODEL: &str = "gigaam-v3-rnnt-int8";
