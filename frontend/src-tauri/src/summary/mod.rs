...
pub use template_commands::{
    ...
    __cmd__api_get_custom_template_json, __cmd__api_get_template_details,
    ...
    __tauri_command_name_api_get_custom_template_json,
    __tauri_command_name_api_get_template_details, __tauri_command_name_api_list_templates,
    __tauri_command_name_api_update_custom_template, __tauri_command_name_api_validate_template,
    api_create_custom_template, api_delete_custom_template, api_get_custom_template_json,
    api_get_template_details, api_list_templates, api_update_custom_template, api_validate_template,
};
